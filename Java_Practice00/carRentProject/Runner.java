...
public class Runner {
	...
	public static void main(String[] args) {
		...
		int aracYili = 0;
		int fiyat=0;
		System.out.println("aracinizi simdiden kiralayin, tatilinizde sinirsiz ozgurlugun ve avantajli kampayalarin keyfini surun");
		...
		while (secim!=3) {
			if (secim == 1) {
				...
				if (secim==1) {
					...
					CarRent car = new CarRent(marka, model, aracYili, fiyat);
				}
			} else  if(secim == 2){
				System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
				...
				if (secim == 2) {
					if (aracYili==0) {
						System.out.println("maselsef elimizde arac kalmamistir");
					} else {
