...
public static void main(String[] args) {
    ...
    Ogrenciler ogr2 = new Ogrenciler(1, "Yaðmur", 23);
    KursKayit kayit1 = new KursKayit(ogr1, kurs1, LocalDate.now());
    kayit1.kayitYaz();
    System.out.println("Kayýt sayýsý : " + KursKayit.kayitSayisi);
    System.out.println(ogr2.adi + "'nin Okul adý : " + ogr1.okulAdi);
    Ogrenciler.okulAdi = "Fatih Vatan Lisesi";
    @SuppressWarnings("unused")
	KursKayit kayit2 = new KursKayit(ogr2, kurs2, LocalDate.now());

    System.out.println(ogr1.adi + "'nin Okul adý : " + ogr1.okulAdi);
    System.out.println(
      "Þuanda kursa kayýtlý öðrenci sayýsý : " + KursKayit.kayitSayisi
    );
