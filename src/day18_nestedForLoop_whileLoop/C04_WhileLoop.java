...
public class C04_WhileLoop {
	...
	public static void main(String[] args) {
		...
		// kullanicidan 5 sayi alin dese for loop
		/* for (int i = 1; i <=5; i++) {
		...
		// cunku loop'un icinde olustrurusak,
		// loop her dondugunde yeni bir obje veya variable olusturur
		...
		// sifiri sayac'a eklememek icin alttaki satirda sayac-1 yaptik
