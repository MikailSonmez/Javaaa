...
public class C01_LocalVariables {
	...
	public static void main(String[] args) {
		...
		// Kodlalarimizda sorun yasamamak icin
		// olusturdugumuz local variable'lara uygun bir deger atamamizda fayda var
		
		int sayi=0; // int sayi; dersek java CTE hatasi verir
		...
		// sayi; // bir local'de olusturulan variable (method'larin static olup 
			      // olmamasina bagli olmaksizin) farkli local'de kullanilamaz
