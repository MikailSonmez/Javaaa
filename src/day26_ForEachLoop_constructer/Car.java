...
public class Car {
	...
	// class isimleri buyuk harf basladigi icin Constructor ismi de buyuk harfle baslar
	// (method'dan 1.farki budur, method'lar kucuk harfle baslar)
	// 2. Constructorlarin return type'si olmaz
	// (method'dan 1.farki budur, method'larin mutlaka return type'i olmalidir)
	public Car() {
	}
	...
	// Main method'u olmayan class'lar baska class'lardan obje olusturularak kullanilmak
	// uzere ihtiyac duyulan variable ve method'lari sakladigimiz bi depo gibidir
}
