...
public class C03_Concrete implements C02_Interface{
	...
	// Interface'de default keyword kullanarak olusturudugumuz body'si olan method'lara
	// child concrete class'lardan obje vasitasiyla ulasabilirim	
	concreteObje.kaporta();
			
			
			
	// Interface'de static keyword kullanarak olusturdugumuz bod'si olan method'lara
	...
	// Bu interface'e implement eden concrete child class'lar bu method'lari
