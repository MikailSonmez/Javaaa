...
public class QTasKagitMakas01 {
	 ...
	 */
		...
		while (cevap.equalsIgnoreCase("EVET")) {
	        ...
	        if (secim == 1) {
				if (bilgisayarin_secimi == 1) {
					System.out.println("bilgisayarin secimi : Tas ===> Sonuc : Beraber");
        ...
        if (kullanici_puani == 3) {
            ...
            System.out.println(" KAZANDINIZZZZZZZZZZZZZZ");
            ...
            System.out.println(" KAYBETTINIZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ");
