...
public class Q06 {
	...
	private static void tekrarlayanCharacterSay1(String str, char val) {
		int count = 0;
	...
	private static void tekrarlayanCharacterSay2(String str, char val) {
		int count = 0;
	...
	private static void tekrarlayanCharacterSayLambda(String str) {
