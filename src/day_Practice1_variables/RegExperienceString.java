package day_Practice1_variables;

public class RegExperienceString {

	public static void main(String[] args) {
		
		
		// str.matches(pattern);
		// str'nin pattern'a uygun olup olmadgini kontrol eder. sonuc boolean doner
		
		// . (nokta) yanliz tek karakter demektir
		...
		// [abc]	yanliz bir karakter ve a, b veya c olmali
		System.out.println("[abc] quantifier ....");
		System.out.println("a".matches("[a]")); // true, str yanliz bir adet a karakterinden olusmali
		...
		System.out.println("abcd".matches("[abcd]")); // false, yanliz a,b,c veya d olmali
        ...
        System.out.println("ab".matches("[abc]?")); // false, a, b veya c en fazla 1 defa
